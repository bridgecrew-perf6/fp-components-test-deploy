...
import { defineComponent, openBlock, createElementBlock, normalizeClass, ref, createBlock, resolveDynamicComponent, withCtx, renderSlot, computed, watch, provide, onMounted, watchEffect, inject, toRaw, onUnmounted, nextTick, h as h$1, Teleport, reactive, unref, onUpdated, cloneVNode, createVNode, createElementVNode, createCommentVNode, toDisplayString, Transition, Fragment, renderList } from "vue";
var index = "";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("i", {
        class: normalizeClass(`fp-icons-${props.name}`)
      }, null, 2);
    };
  }
});
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    switch (props.size) {
      case "1":
        headingClass.value = `text-6xl font-bold`;
        break;
      case "2":
        headingClass.value = `text-5xl font-bold`;
        break;
      case "3":
        headingClass.value = `text-4xl font-bold`;
        break;
      case "4":
        headingClass.value = `text-3xl font-bold`;
        break;
      case "5":
        headingClass.value = `text-2xl font-bold`;
        break;
      case "6":
        headingClass.value = `text-xl font-bold`;
        break;
    }
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(__props.as), {
        class: normalizeClass(headingClass.value)
      }, {
        default: withCtx(() => [
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    switch (props.size) {
      case "1":
        headingClass.value = `text-6xl`;
        break;
      case "2":
        headingClass.value = `text-5xl`;
        break;
      case "3":
        headingClass.value = `text-4xl`;
        break;
      case "4":
        headingClass.value = `text-3xl`;
        break;
      case "5":
        headingClass.value = `text-2xl`;
        break;
      case "6":
        headingClass.value = `text-xl`;
        break;
    }
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(__props.as), {
...
const _hoisted_2 = { class: "leading-normal" };
const _hoisted_3 = ["href"];
const _hoisted_4 = {
  key: 0,
  class: "mr-2"
};
const _hoisted_5 = { class: "leading-normal" };
const _hoisted_6 = ["onClick"];
const _hoisted_7 = {
  key: 0,
  class: "mr-2"
};
const _hoisted_8 = { class: "leading-normal" };
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const handleItemClick = (e, item, disabled) => {
      if (item.onItemClicked && !disabled)
        return item.onItemClicked(item, e);
    };
    return (_ctx, _cache) => {
        ...
        default: withCtx(() => {
          ...
          return [
            createVNode(unref(_a), {
              as: __props.item.link ? "a" : "button",
              class: "w-full",
              href: __props.item.link,
              disabled: __props.isDisabled,
              onClick: _cache[0] || (_cache[0] = ($event) => handleItemClick($event, __props.item, __props.isDisabled))
            }, {
              default: withCtx(({ open }) => [
                createElementVNode("span", {
                  class: normalizeClass(["w-full block text-left px-4 py-2 flex items-center justify-between", {
                    "bg-blue-500": __props.isActive,
                    "opacity-50 cursor-default": __props.isDisabled,
                    "opacity-50 cursor-default disabled": __props.isDisabled
                  }]),
                  type: "button"
                }, [
                  createElementVNode("span", null, [
                    __props.item.icon ? (openBlock(), createElementBlock("span", _hoisted_1, [
                      createVNode(unref(_sfc_main$4), {
                        name: __props.item.icon
                      }, null, 8, ["name"])
                    ])) : createCommentVNode("", true),
                    createElementVNode("span", _hoisted_2, toDisplayString(__props.item.label), 1)
                  ]),
                  __props.item.items ? (openBlock(), createBlock(unref(_sfc_main$4), {
                    key: 0,
            ...
            ((_a2 = __props.item.items) == null ? void 0 : _a2.length) ? (openBlock(), createBlock(Transition, {
              key: 0,
              ...
              default: withCtx(() => [
                createVNode(unref(qa), { class: "absolute left-full top-0 w-56 origin-top-right bg-white divide-y divide-gray-100 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" }, {
                  default: withCtx(() => [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(__props.item.items, (subItem) => {
                      return openBlock(), createBlock(unref(za), {
                        key: subItem.id,
                        disabled: subItem.isDisabled
                      }, {
                        default: withCtx(({ active, disabled }) => [
                          createElementVNode("div", null, [
                            subItem.link ? (openBlock(), createElementBlock("a", {
                              key: 0,
                              class: normalizeClass(["w-full block text-left px-4 py-2 flex items-center", {
                                "bg-blue-500": active,
                                "opacity-50 cursor-default": disabled
                              }]),
                              href: subItem.link
                            }, [
                              subItem.icon ? (openBlock(), createElementBlock("span", _hoisted_4, [
                                createVNode(unref(_sfc_main$4), {
                                  name: subItem.icon
                                }, null, 8, ["name"])
                              ])) : createCommentVNode("", true),
                              createElementVNode("span", _hoisted_5, toDisplayString(subItem.label), 1)
                            ], 10, _hoisted_3)) : (openBlock(), createElementBlock("button", {
                              key: 1,
                              class: normalizeClass(["w-full block text-left px-4 py-2 flex items-center", {
                                "bg-blue-500": active,
                                "opacity-50 cursor-default": disabled
                              ...
                              type: "button",
                              onClick: ($event) => handleItemClick($event, subItem, disabled)
                            }, [
                              subItem.icon ? (openBlock(), createElementBlock("span", _hoisted_7, [
                                createVNode(unref(_sfc_main$4), {
                                  name: subItem.icon
                                }, null, 8, ["name"])
                              ])) : createCommentVNode("", true),
                              createElementVNode("span", _hoisted_8, toDisplayString(subItem.label), 1)
                            ], 10, _hoisted_6))
                          ])
                        ]),
                        _: 2
      ...
      return openBlock(), createBlock(unref(Ga), {
        ...
        default: withCtx(() => [
          ...
          createVNode(Transition, {
            ...
            default: withCtx(() => [
              createVNode(unref(qa), { class: "absolute right-0 w-56 mt-2 origin-top-right bg-white divide-y divide-gray-100 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" }, {
                default: withCtx(() => [
                    ...
                    return openBlock(), createBlock(unref(za), {
                      ...
                      default: withCtx(({ active, disabled }) => [
                        createVNode(_sfc_main$1, {
                          ...
                          "is-active": active
                        }, null, 8, ["item", "is-disabled", "is-active"])
                      ]),
                      _: 2
                    }, 1032, ["disabled"]);
                  }), 128))
...
export { _sfc_main as FPDropdown, _sfc_main$3 as FPHeading, _sfc_main$4 as FPIcon, _sfc_main$2 as FPText };
//# sourceMappingURL=fp-components.es.js.map
